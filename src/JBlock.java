...
public class JBlock extends Tetrimino {
	...
	minos[0] = new Location(3, 22);
	minos[1] = new Location(3, 21);
	...
	switch (orientation) {
	    case UP: {
		minos[0] = new Location(minos[0].x + 2, minos[0].y);
		minos[1] = new Location(minos[1].x + 1, minos[1].y + 1);
		minos[3] = new Location(minos[3].x - 1, minos[3].y - 1);
		this.orientation = Orientation.RIGHT;
		break;
	    }
	    case RIGHT: {
		minos[0] = new Location(minos[0].x, minos[0].y - 2);
		minos[1] = new Location(minos[1].x + 1, minos[1].y - 1);
		minos[3] = new Location(minos[3].x - 1, minos[3].y + 1);
